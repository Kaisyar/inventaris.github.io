...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query(
            $conn,"update sstock_brg set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran', satuan='$satuan', harga='$harga' where idx='$idx'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><h4 style="color :white;" >SISTEM INFORMASI INVENTARIS BARANG</h4></a>
            </div>
            <div class="main-menu">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
                                ...
                                <div class="form-group">
									<label>Harga</label>
									<input name="harga" type="text" min="0" class="form-control" placeholder="Rp">
								</div>
							</div>
							<div class="modal-footer">
